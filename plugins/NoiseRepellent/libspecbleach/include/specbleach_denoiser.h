...
typedef struct SpectralBleachParameters {
  ...
  bool transient_protection; // Enables or disables the transient protection when smoothing_factor is being used. This
                             // can help to preserve transient content when smoothing is strong.
  float whitening_factor; // Percentage of whitening that is going to be applied to the residue of the reduction. It
                          // modifies the noise floor to be more like white noise. This can help hide musical noise when
                          // the noise is colored. It goes from 0 to 100 percent
  float
